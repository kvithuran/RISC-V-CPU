...
module andTB();
	reg clock;
	reg PCout, Zlowout, MDRout,R3out, R5out, R6out, R7out; // add any other signals to see in your simulation
...
DataPath DUT (
    ...
    .A(32'b0),
    .RegisterAImmediate(32'b0),
    .Register1Immediate(32'b0),
    .Register2Immediate(32'b0),
