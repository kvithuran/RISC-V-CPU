...
wire clear;
wire CONin;
wire HIout, LOout, Zhighout, Zlowout, PCout, MDRout, InPortout, Cout, IRout, MARout, OutPortout;
wire HIin, LOin, Zhighin, Zlowin, PCin, MDRin, InPortin, Cin, IRin, Yin, MARin, OutPortin;
wire read, write, IncPC, Grb, Gra, Grc;
wire Rout, Rin, BAout;
...
control_unit control_unit(
    .clock(clock), .clear(clear), .HIout(HIout), .LOout(LOout), .Zhighout(Zhighout), .Zlowout(Zlowout), .PCout(PCout), .MDRout(MDRout), .InPortout(InPortout), .Cout(Cout), .IRout(IRout), .MARout(MARout), .OutPortout(OutPortout),
    .HIin(HIin), .LOin(LOin), .Zhighin(Zhighin), .Zlowin(Zlowin), .PCin(PCin), .MDRin(MDRin), .InPortin(InPortin), .Cin(Cin), .IRin(IRin), .Yin(Yin), .MARin(MARin), .OutPortin(OutPortin), .CONin(CONin),
